...
const I18N = {
  de: {
    ...
    "display.modeAlternate":"API-Wert und Uhrzeit im Wechsel","display.alternate":"Uhrzeit-Anzeigedauer (s)",
  ...
  en: {
    ...
    "display.modeAlternate":"Alternate API value and clock","display.alternate":"Clock display duration (s)",
